package me.lty.basemvplibrary.net;
...
public class Network {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            Logger.i(TAG, "-------------$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$-------------");
            Logger.i(TAG, "getActiveNetworkInfo: " + in);
            ...
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    ...
                    Logger.i(TAG, "NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i]
    ...
    public static int getConnectedTypeINT(Context context) {
        NetworkInfo net = getConnectivityManager(context).getActiveNetworkInfo();
        if (net != null) {
            Logger.i(TAG, "NetworkInfo: " + net.toString());
            return net.getType();
        }
        return -1;
    }
     ...
     *
     * @return {@link TelephonyManager#NETWORK_TYPE_CDMA},
